...
fo = open("rec_data_ml_1m_predict_cut.json", "w", encoding="utf8")
for line in fi.readlines()[-500:]:
    ...
    prompt += "Based on above user history information, "
    pos_profile = id2profile[arr[-2]]
    neg_profile = id2profile[arr[-1]]
    candidates = "< Name:" + pos_profile[0] + " Year:" + pos_profile[1] + " Genre:" + pos_profile[2] +   " > " + "< Name:" + neg_profile[0] + " Year:" + neg_profile[1] + " Genre:" + neg_profile[2] +   " >, "
    prompt += "given two candidates: " + candidates
    prompt += "I can make a recommendation: "
    obj = {}
